from data_formatters.base import DataTypes, InputTypes, GenericDataFormatter
...
class FavoritaFormatter(GenericDataFormatter):
  ...
  """
    ...
    def split_data(self, df: DataFrame, valid_boundary=None, test_boundary=None) -> Tuple:
    ...
    def set_scalers(self, df: DataFrame, set_real: bool = True):
