...
class HyperparamOptManager:
  ...
  """
    ...
    def __init__(self,
                 ...
                 fixed_params,
                 model_folder,
                 override_w_fixed_params: bool =True):
        """Instantiates model.
    Args:
      param_ranges: Discrete hyperparameter range for random search.
      fixed_params: Fixed model parameters per experiment.
    ...
    def _get_params_from_name(self, name: str) -> Dict:
...
class DistributedHyperparamOptManager(HyperparamOptManager):
    ...
    @property
    def optimisation_completed(self) -> bool:
        return False if self.worker_search_queue else True

    def get_next_parameters(self) -> Dict:
    ...
    def load_serialised_hyperparam_df(self) -> DataFrame:
    ...
    def update_serialised_hyperparam_df(self) -> DataFrame:
    ...
    def _generate_full_hyperparam_df(self) -> DataFrame:
    ...
    def _get_worker_search_queue(self) -> deque:
    ...
    def assign_worker_numbers(self, df: DataFrame) -> DataFrame:
